...
class RichTextCodeMirror {
  ...
  onCursorActivity_ () {
    setTimeout(() => {
      ...
      // 实时文本属性
      let realtimeTextAttrs = this.getCurrentAttributes_()
      let lineAttrs = this.getCurrentLineAttributes_()
      for (let attr in lineAttrs) {
        realtimeTextAttrs[attr] = lineAttrs[attr]
      }
